...
useEffect(() => {
  ...
  return (
    <div className="App">
      ...
      <img src={logo} className="App-logo" alt="logo" style={{marginLeft : '50px',width:'100px'}}/>
        <h1 style={{marginRight:'130px',fontSize:'25px',fontFamily:'serif',fontWeight:'bold'}}>AUTO CRAFTER</h1>
  ...
  <span class="tooltip">Fullscreen</span>
              ...
              <button className="export1" onClick={exportBpmnAsSVG} >Export as SVG</button>
              <button className="export1" onClick={exportBpmnAsPNG} >Export as PNG</button>
              <button className="export1" onClick={exportAsBpmn} >Export as BPMN</button>
              <button className="export1"  >Export to blueworks</button>
              <div className='export1' style={{marginLeft:'10px'}}>
              <label>
                Task Color
  ...
  <span class="tooltip">Fullscreen</span>
              ...
              <button className="export1" onClick={exportMermaidAsSVG}>Export as SVG</button>
              <button className="export1" onClick={exportMermaidAsPNG}>Export as PNG</button>
              <button className="export1" onClick={exportAsMarkdown}>Export as .md</button>
              <div className="mermaid-controls">
                
                               <label className='export1'style={{fontSize:'23px',fontWeight:'bold',fontFamily:'serif'}}> Rough</label> 
              <label className='switch' style={{marginLeft:'7px'}}>
                ...
                <label className='export1'style={{fontSize:'20px',fontWeight:'bold',fontFamily:'serif'}}> Pan and Zoom</label>
                <label className='switch' style={{marginLeft:'7px'}}>
      ...
      <div className="left-sidebar">
          <div className="tabs">
          <Button className={`tab-button  ${activeTab === 'scenario' ? 'active' : ''}`} onClick={() => switchTab('scenario') } style={{color:'white',fontWeight:'bolder'}}  >
                        Scenario
                    </Button>
                    <Button className={` tab-button ${activeTab === 'prompt' ? 'active' : ''}`} onClick={() => switchTab('prompt')} style={{marginTop:'30px',color:'white',fontWeight:'bolder'}}> 
                        Chat
                    </Button>
                    <Button className={`tab-button ${activeTab === 'code' ? 'active' : ''}`} onClick={() => {  switchTab('code'); }} style={{marginTop:'30px',color:'white',fontWeight:'bolder'}}>
    Code
</Button>
        ...
        <label className="switch" style={{marginBottom:'20px',marginLeft:'600px'}}>
          <input
            type="checkbox"
            checked={isBpmn}
  ...
  <div class="tab tab-horizontal tab-active">Scenario</div>
  <div class="tab tab-horizontal">Prompt</div>
  <div class="tab tab-horizontal">Code</div>
</div>
